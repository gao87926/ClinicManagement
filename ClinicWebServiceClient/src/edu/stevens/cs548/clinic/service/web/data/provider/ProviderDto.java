...
package edu.stevens.cs548.clinic.service.web.data.provider;
...
public class ProviderDto  implements java.io.Serializable {
    ...
    /**
     * Gets the spec value for this ProviderDto.
     * 
     * @return spec
     */
    ...
    /**
     * Sets the spec value for this ProviderDto.
     * 
     * @param spec
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://cs548.stevens.edu/clinic/service/web/data/provider", ">ProviderDto"));
